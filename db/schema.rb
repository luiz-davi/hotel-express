...
ActiveRecord::Schema[7.0].define(version: 2022_11_09_011524) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "encomendas", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "inquilino_id", null: false
    t.datetime "data_entregue"
    t.text "observacao"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["inquilino_id"], name: "index_encomendas_on_inquilino_id"
  ...
  add_foreign_key "encomendas", "inquilinos"
